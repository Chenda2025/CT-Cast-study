const I18N = {
  en: {
    ...
    "hero.lead": "Configure compression, run benchmarks, and watch where CPU cost meets disk savings.",
    "flow.1": "Download",
    "flow.2": "Configure",
    "flow.3": "Benchmark",
    "flow.4": "Decide",
    "actions.setup": "Setup",
    "actions.bench": "Benchmarks",
    "badge.auto": "Auto",
  ...
  km: {
    ...
    "hero.lead": "កំណត់ការបង្ហាប់ ដំណើរការតេស្ត ហើយមើលចំណុចដែលតម្លៃ CPU ជួបនឹងការសន្សំថាស។",
    "flow.1": "ទាញយក",
    "flow.2": "កំណត់",
    "flow.3": "តេស្ត",
    "flow.4": "សម្រេច",
    "actions.setup": "រៀបចំ",
    "actions.bench": "តេស្តប្រៀបធៀប",
    "badge.auto": "ស្វ័យប្រវត្តិ",
    "nav.slides": "បទបង្ហាញ",
    "nav.docs": "ឯកសារ API",
    "lang.toggle": "English",
